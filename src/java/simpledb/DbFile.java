...
public interface DbFile {
     ...
     * @param t   The tuple to add.  This tuple should be updated to reflect that it is now stored in this file.
     ...
     *
     * @param tid The transaction performing the update
     * @param t   The tuple to delete.  This tuple should be updated to reflect that it is no longer stored on any
     *            page.
     * @return An ArrayList contain the pages that were modified
