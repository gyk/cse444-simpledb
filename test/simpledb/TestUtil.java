...
public class TestUtil {
     ...
     * @return a DbIterator over a list of tuples constructed over the data provided in the constructor. This iterator
     * is already open.
    ...
    /**
     * @param width   the number of fields in each tuple
     * @param tupdata an array such that the ith element the jth tuple lives in slot j * width + i.  Objects can be
     *                strings or ints;  tuples must all be of same type.
     * @return a DbIterator over a list of tuples constructed over the data provided in the constructor. This iterator
     * is already open.
     * @throws DbException if we encounter an error creating the TupleIterator
     * @require tupdata.length % width == 0
